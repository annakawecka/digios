...
void poster_angular_dist_17Fw17Orecoils_half_dets_relative_sf_sm_i() {
  ...
  labels = {
    {"\\ell = 2, 0d5/2\\;0^{+}, 6.136", "\\ell = 0, 1s1/2\\;3^{+}, 6.163", "\\ell = 2, 0d3/2\\;3^{+}, 6.163", "\\ell = 2, 0d5/2\\;3^{+}, 6.163"}, // 6136_6163 will probably be IAS of thr 5.34 (d) and 5.38 (s) states in O; there might be also addition of 6.108 state in F, I'm not sure what l is that, but also 6.108 is T=0 state so it's weaker
  ...
  TString outputDir = Form("plots_17Fw17Orecoils/minuit_extra5/ang_dist_fixedRatio_smi_newunc/%s", pot.Data());
