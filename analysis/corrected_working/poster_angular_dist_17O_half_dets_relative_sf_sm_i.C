...
// relative coefficients from shell-model calculations, i (including isospin)
...
void poster_angular_dist_17O_half_dets_relative_sf_sm_i() {
  ...
  data = {ex1982_half_dets, ex3920_half_dets, ex3552_3630_half_dets, ex5255_5340_5375_half_dets, ex6200_half_dets, ex6200_half_dets, ex6930_half_dets, ex7100_half_dets};
  ...
  labels = {
    ...
    {"\\ell = 2, 0d5/2\\;0^{+}, 5.340", "\\ell = 0, 1s1/2\\;2^{+}, 5.255", "\\ell = 2, 0d3/2\\;2^{+}, 5.255", "\\ell = 2, 0d5/2\\;2^{+}, 5.255", "\\ell = 0, 1s1/2\\;3^{+}, 5.375"}, // 5.255 & 5.340 & 5.375
    {"\\ell = 1, 1p3/2\\;1^{-}"}, // 6200
    {"\\ell = 3, 0f7/2\\;1^{-}"}, // 6200
  ...
  TString outputDir = Form("plots_17O/minuit_extra5/ang_dist_fixedRatio_smi_newunc/%s", pot.Data());
  ...
  fitMappings = {
    ...
    {ex5255_5340_5375_half_dets, {26, 27, 42, 43, 28}},
    {ex6200_half_dets, {29}},
    {ex6200_half_dets, {40}},
  ...
  fitPairs =  {
    {{0, 2}, {0.3282, 1.2287}}, // 1.982, 1s1/2 and 0d5/2 relative SF
    {{15, 13}, {0.6208, 0.7274}}, // 3.920, 1s1/2 and 0d5/2 relative SF
    {{36, 37}, {1.86, 0.325}}, // 3.552 & 3.630, 4+ and 0+ relative SF
    {{26, 27, 42, 43, 28}, {0.13, 0.015, 0.8934, 0.0108, 0.99}}, // 5.255, 5.340, 5.375, 0+, 2+, 3+ relative SF, so 5.340, 5.255 and 5.375, respectively
    {{29}, {1.0}}, // 6.200
    {{40}, {1.0}}, // 6.200
    {{30}, {1.0}}, // 6.930
    {{31}, {1.0}}, // 6.930
