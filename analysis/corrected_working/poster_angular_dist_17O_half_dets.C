...
void poster_angular_dist_17O_half_dets() {
  ...
  std::vector<std::vector<double>> ex1982_half_dets = {
    {8.00 , 14.62, 6.62, 11.31, 1.2983, 28.4242}, // 2
    {14.86, 18.56, 3.70, 16.71, 1.0635, 17.2772}, // 3
    {19.89, 22.62, 2.73, 21.26, 0.9886, 16.2642}, // 4
    {22.76, 25.15, 2.39, 23.95, 0.9711, 12.7089}, // 5
    {26.10, 28.20, 2.10, 27.15, 0.9562, 10.2986}, // 6
    {28.30, 30.25, 1.94, 29.27, 0.9510, 10.5578}, // 7
    {31.07, 32.86, 1.78, 31.97, 0.9448, 6.15872 * 4./3.}, // 8
    {32.95, 34.64, 1.69, 33.80, 0.9410, 4.24311 * 4./3.}, // 9
    {35.32, 36.92, 1.60, 36.12, 0.9407, 3.42685 * 4./3.}, //10
    {37.00, 38.53, 1.53, 37.77, 0.9362, 2.27111 * 4./3.}, //11
  };
  ...
  std::vector<std::vector<double>> ex3920_half_dets = {
    ...
    {19.72, 22.59, 2.87, 21.15, 1.0362, 14.5072}, // 6
    {22.73, 25.23, 2.50, 23.98, 1.0159, 15.1933}, // 7
    {26.26, 28.44, 2.18, 27.35, 1.0007, 8.45285 * 4./3.}, // 8
    {28.55, 30.56, 2.02, 29.56, 0.9950, 9.04236 * 4./3.}, // 9
    {31.36, 33.22, 1.85, 32.29, 0.9899, 7.50488 * 4./3.}, //10
    {33.31, 35.07, 1.76, 34.19, 0.9877, 6.11097 * 4./3.}, //11
  };
  ...
  std::vector<std::vector<double>> ex3552_3630_half_dets = {
    ...
    {21.17, 23.83, 2.66, 22.50, 1.0161, 48.8069}, // 6
    {23.96, 26.31, 2.35, 25.14, 0.9992, 37.5365}, // 7
    {27.29, 29.38, 2.08, 28.33, 0.9889, 20.0825 * 4./3.}, // 8
    {29.48, 31.42, 1.94, 30.45, 0.9840, 15.6256 * 4./3.}, // 9
    {32.20, 33.99, 1.80, 33.09, 0.9803, 11.3624 * 4./3.}, //10
    {34.08, 35.79, 1.70, 34.94, 0.9760, 10.1256 * 4./3.}, //11
  };

  std::vector<std::vector<double>> ex5255_5340_5375_half_dets = {
    {11.04, 16.48, 5.44, 13.76, 1.2938, 10.36 + 0 + 21.1155}, // 6
    {16.69, 20.20, 3.51, 18.45, 1.1096, 5.55457 + 0 + 3.17525}, // 7
    {21.54, 24.26, 2.72, 22.90, 1.0595, (8.63332 + 0.725115 + 0.01896) * 4./3.}, // 8
    {24.39, 26.81, 2.42, 25.60, 1.0449, (9.73567 + 4.43685 + 0) * 4./3.}, // 9
    {27.75, 29.90, 2.14, 28.82, 1.0339, (12.7922 + 0 + 2.47708) * 4./3.}, //10
    {30.01, 32.00, 2.00, 31.00, 1.0281, (13.0306 + 2.34372 + 0) * 4./3.}, //11
  ...
  std::vector<std::vector<double>> ex6200_half_dets = {
    { 8.00, 15.58, 7.58, 11.75, 1.5436, 2.200021}, // 7
    {17.42, 20.85, 3.43, 19.14, 1.1240, 1.77982 * 4./3.}, // 8
    {21.01, 23.86, 2.85, 22.44, 1.0864, 1.23201 * 4./3.}, // 9
    {24.94, 27.36, 2.42, 26.15, 1.0655, 1.04040 * 4./3.}, //10
    {27.48, 29.69, 2.21, 28.59, 1.0593, 0.5536  * 4./3.}, //11
  };

  std::vector<std::vector<double>> ex6930_half_dets = {
    {12.15, 17.19, 5.04, 14.67, 1.2773, 3.80869 * 4./3.}, // 8
    {17.40, 20.89, 3.49, 19.14, 1.1460, 4.12727 * 4./3.}, // 9
    {22.15, 24.91, 2.76, 23.53, 1.1025, 2.44996 * 4./3.}, //10
  ...
  Ex_values = {1.982, 3.920, 3.552, 5.255, 6.200, 6.930};
  labels = {
    ...
    {"\\ell = 1"}, // 6200
    {"\\ell = 1", "\\ell = 3", "\\ell = 3", "\\ell = 2", "\\ell = 2", "\\ell = 0"}  // 6930
  };
  ...
  fitMappings = {
    ...
    {ex6200_half_dets, {29}},
    {ex6930_half_dets, {30, 31, 32, 33, 34, 35}}
  };
  fitPairs =  {
    {{0, 2}},
    {{15, 13}},
