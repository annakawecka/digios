...
void poster_angular_dist_17F_half_dets_relative_sf_sm_i() {
  ...
  TString outputDir = Form("plots_17F/minuit_new/ang_dist_fixedRatio_smi_newunc/%s", pot.Data());
  ...
  fitPairs =  {
    ...
    {{2, 3, 4}, {0.067, 0.0002, 0.4079}}, // 4.694: 1s1/2, 0d5/2, 0d3/2
    {{5, 6, 33}, {0.3356, 0.0703, 0.0095}}, // 3.061, 1s1/2, 0d5/2, 0d3/2 
    {{29, 38, 30}, {0.9241, 0.0349, 0.1794}}, // 4.652: 0d5/2, 0d3/2, 4.753: 0d5/2
    {{21, 37}, {0.1860, 0.1908}}, // 4.360
    {{20, 19, 36}, {0.5290, 0.0003, 0.0037}}, // 4.115: 1s1/2, 0d5/2, od3/2
    {{22, 34, 24, 35, 23}, {0.0987, 0.087, 0.3370, 0.0034, 0.3924}} // 3.724: 0d5/2, 0d3/2, 3.839:1s1/2, 0d3/2, 0d5/2
  };
