...
void fitHistogramLikelihoodTMinuit(TH1* hist,
  ...
  // Background
  minuit.mnparm(0, "BG_intercept",  hist->GetBinContent(hist->FindBin((fitMin+fitMax)/2.0)), 0.1, 0., 3.0, ierflg);
  minuit.mnparm(1, "BG_slope",      0.0, 0.01, 0., 0.1, ierflg);
...
void fitting_17Fw17Orecoils_half_dets_minuit() {
  ...
  std::vector<std::string> histNames = {"Ex_d6_half_dets_17Orecoil", "Ex_d7_half_dets_17Orecoil",
					"Ex_d8_half_dets_17Orecoil", "Ex_d9_half_dets_17Orecoil",
					"Ex_d10_half_dets_17Orecoil", "Ex_d11_half_dets_17Orecoil"};

  std::vector<std::vector<double>> peakSets = {
    {6.136, 6.163, 6.633, 6.643},
    {6.136, 6.163, 6.633, 6.643, 7.336, 7.528, 7.729, 8.115},
    {6.136, 6.163, 6.633, 6.643, 7.336, 7.528, 7.729, 8.115},
    {6.136, 6.163, 6.633, 6.643, 7.336, 7.528, 7.729, 8.115},
    {6.136, 6.163, 6.633, 6.643, 7.336, 7.528, 7.729, 8.115},
    {6.136, 6.163, 6.633, 6.643, 7.336, 7.528, 7.729, 8.115}
