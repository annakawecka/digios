...
void poster_angular_dist_17F_half_dets_relative_sf() {
  ...
  TString outputDir = Form("plots_17F/minuit_new/ang_dist_fixedRatio_newunc/%s", pot.Data());
  ...
  fitPairs =  {
    {{25, 26, 27, 28}, {0.306, 0.102, 0.96, 0.89}},
    ...
    {{21}, {1.0}}, // 4.360
    {{20, 19}, {0.17, 0.68}}, // 4.115
    {{24, 23, 22}, {1.0, 1.0, 1.0}} // 3.724 & 3.839 // not sure which l
  };
