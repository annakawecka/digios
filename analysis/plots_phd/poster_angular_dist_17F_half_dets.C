...
void poster_angular_dist_17F_half_dets() {
  ...
  std::vector<std::vector<double>> ex0937_1041_1121_half_dets = {
    { 8.40, 15.00, 6.60, 11.70, 1.3384, (13.2355 + 7.30814 + 5.04478),  sqrt( pow( 2.9457, 2) + pow( 3.87, 2) + pow( 2.549, 2) ) }, // 0
    {15.21, 18.71, 3.50, 16.96, 1.0216, (3.94081 + 11.0333 + 5.58712),  sqrt( pow( 2.04, 2) + pow( 3.84, 2) + pow( 4.668, 2) )}, // 1
    {19.99, 22.61, 2.62, 21.30, 0.9516, (1.69996 + 0 + 14.5829),        sqrt( pow( 1.4475, 2) + pow( 1.77443, 2) )}, // 2
    {22.74, 25.05, 2.31, 23.90, 0.9366, (1.42418 + 8.92131 + 8.23189),  sqrt( pow( 1.37, 2) + pow( 3.689, 2) + pow( 3.3501, 2) )}, // 3
    {25.98, 28.01, 2.03, 27.00, 0.9218, (3.03473 + 0.173152 + 12.7338), sqrt( pow( 0.92, 2) + pow( 1.7, 2) )}, // 4
    {28.11, 30.00, 1.89, 29.06, 0.9166, (3.5703 + 0. + 9.39902),        sqrt( pow( 0.72, 2) + pow( 0.98, 2) )}, // 5
    {30.77, 32.50, 1.73, 31.64, 0.9099, (3.27858 + 0. + 9.2654),        sqrt( pow( 0.6087, 2) + pow( 0.9217, 2) )}, // 6
    {32.59, 34.24, 1.65, 33.42, 0.9081, (1.31148 + 0. + 8.8856),        sqrt( pow( 0.477, 2) + pow( 0.9083, 2) )}, // 7
    {34.95, 36.50, 1.55, 35.73, 0.9032, (0.449797 + 0.000258 + 2.93755) * 4./3., sqrt( pow( 0.267, 2) + pow( 1.158, 2) + pow( 0.517, 2))}, // 8
    {36.58, 38.07, 1.49, 37.32, 0.9044, (0.568829 + 0.01185 + 3.00139) * 4./3.,  sqrt( pow( 0.34, 2) + pow( 0.617, 2) )}, // 9
    {38.67, 40.09, 1.42, 39.38, 0.9023, (3.15072) * 4./3.,  sqrt( pow( 0.49, 2) + pow( 0., 2) )}, //10
    {40.17, 41.54, 1.38, 40.85, 0.8996, (0.677276) * 4./3., sqrt( pow( 0.23, 2) + pow( 0., 2) )} //11
  }; // mean is 1.029

  std::vector<std::vector<double>> ex3061_half_dets = {
    {8.6  , 14.35, 5.75, 11.475, 1.1439,  5.76304, 0.658813}, // 2
    {14.60, 18.40, 3.80, 16.50,  1.0804,  5.7179,  0.7023}, // 3
    {19.76, 22.52, 2.77, 21.14,  0.9979,  4.93428, 0.60}, // 4
    {22.66, 25.08, 2.42, 23.87,  0.9795,  4.64378, 0.608}, // 5
    {26.04, 28.15, 2.11, 27.10,  0.9629,  3.41079, 0.51562}, // 6
    {28.26, 30.22, 1.96, 29.24,  0.9577,  3.23499, 0.497581}, // 7
    {31.05, 32.85, 1.80, 31.95,  0.9512,  1.07583 * 4./3., 0.309092}, // 8
    {32.94, 34.65, 1.70, 33.80,  0.9476,  1.91486 * 4./3., 0.382529}, // 9
    {35.33, 36.94, 1.61, 36.14,  0.9473,  0.76595 * 4./3., 0.272617}, //10
    {37.02, 38.56, 1.54, 37.79,  0.9428,  1.63772 * 4./3., 0.365782} //11
  };

  std::vector<std::vector<double>> ex3724_3839_half_dets = { // 3.79
    { 8.20, 14.74, 6.54, 11.47, 1.3005,  (0.487773 + 20.1041), sqrt( pow(5.06347, 2) + pow(3.3762, 2) )}, // 3
    {16.54, 19.92, 3.38, 18.23, 1.0572,  (1.75304 + 3.55357),  sqrt( pow(0.561044, 2) + pow(0.691994, 2) )}, // 4
    {20.08, 22.84, 2.77, 21.46, 1.0117,  (3.2814 + 1.80978),   sqrt( pow(0.8212, 2) + pow(0.823344, 2) )}, // 5
    {23.92, 26.25, 2.33, 25.08, 0.9874,  (1.4294 + 3.70091),   sqrt( pow(0.556658, 2) + pow(0.705114, 2) )}, // 6
    {26.36, 28.49, 2.13, 27.43, 0.9791,  (1.14742 + 5.24187),  sqrt( pow(0.6758, 2) + pow(0.885512, 2) )}, // 7
    {29.38, 31.31, 1.92, 30.35, 0.9716,  (0. + 3.77986) * 4./3.,       sqrt( pow(0.5354, 2) + pow(0., 2) )}, // 8
    {31.41, 33.22, 1.81, 32.31, 0.9682,  (0.207111 + 2.60804) * 4./3., sqrt( pow(0.310743, 2) + pow(0.51939, 2) )}, // 9
    {33.94, 35.63, 1.69, 34.79, 0.9627,  (0.8015 + 2.0848) * 4./3.,    sqrt( pow(0.526342, 2) + pow(0.620528, 2) )}, //10
    {35.72, 37.33, 1.62, 36.53, 0.9619,  (0.753033 + 1.19958) * 4./3., sqrt( pow(0.58534, 2) + pow(0.668129, 2) )} //11
  };

  std::vector<std::vector<double>> ex4115_half_dets = {
    {14.71, 18.56, 3.85, 16.63, 1.1012,  10.7236, 0.908082}, // 4
    {18.73, 21.72, 2.99, 20.22, 1.0329,  10.8906, 0.933796}, // 5
    {22.86, 25.31, 2.45, 24.09, 1.0004,  9.79403, 0.865031}, // 6
    {25.43, 27.65, 2.22, 26.54, 0.9901,  6.87214, 0.761571}, // 7
    {28.58, 30.57, 1.99, 29.57, 0.9808,  3.30765 * 4./3., 0.522647}, // 8
    {30.67, 32.53, 1.86, 31.60, 0.9763,  3.78165 * 4./3., 0.550127}, // 9
    {33.27, 35.01, 1.74, 34.14, 0.9739,  3.29471 * 4./3., 0.518427}, //10
    {35.10, 36.75, 1.65, 35.92, 0.9695,  3.32874 * 4./3., 0.690289} //11
  };

  std::vector<std::vector<double>> ex4360_half_dets = {
    {13.01, 17.42, 4.41, 15.22, 1.1582,  1.23553, 0.397278}, // 4
    {17.61, 20.81, 3.20, 19.21, 1.0534,  1.0575,  0.5129}, // 5
    {22.02, 24.57, 2.55, 23.30, 1.0097,  0.2632,  0.259}, // 6
    {24.70, 26.99, 2.29, 25.85, 1.0004,  1.25035, 0.431587}, // 7
    {27.95, 29.99, 2.04, 28.97, 0.9885,  0.710929 * 4./3., 0.29516}, // 8
    {30.09, 32.00, 1.91, 31.05, 0.9841,  0.807541 * 4./3., 0.3157} // 9
  };
  ...
  std::vector<std::vector<double>> ex4652_4753_half_dets = { // theta values for 4.702 - avg value of energies
    { 8.20, 15.61, 7.41, 11.91, 1.5286, (21.0052 + 0.436834), 1.6249}, // 4
    {15.84, 19.43, 3.59, 17.63, 1.0890, 20.5967, 1.27427}, // 5
    {20.74, 23.47, 2.73, 22.10, 1.0284, 15.1561, 1.05519}, // 6
    {23.61, 26.02, 2.42, 24.81, 1.0136, 13.0476, 1.00247}, // 7
    {27.02, 29.14, 2.12, 28.08, 0.9982, 6.08755 * 4./3., 0.673348}, // 8
    {29.25, 31.22, 1.97, 30.23, 0.9936, 4.54548 * 4./3., 0.596529}, // 9
    {32.01, 33.82, 1.82, 32.91, 0.9873, (3.86017) * 4./3., 0.562701}, //10 - I don't trust this too much
    {33.92, 35.64, 1.73, 34.78, 0.9846, (3.65818 + 0.517828) * 4./3., sqrt( pow(1.27, 2) + pow(1.17135, 2) )} //11 - I don't trust this too much
  };

  std::vector<std::vector<double>> ex4964_half_dets = {
    {8.2  , 13.94, 5.74, 11.07, 1.1021, 8.57289, 0.847075}, // 4
    {14.20, 18.26, 4.06, 16.23, 1.1354, 7.30343, 0.783341}, // 5
    {19.67, 22.57, 2.90, 21.12, 1.0441, 4.63121, 0.603035}, // 6
    {22.71, 25.23, 2.52, 23.97, 1.0231, 4.8697,  0.637558}, // 7
    {26.27, 28.46, 2.19, 27.36, 1.0074, 3.66391 * 4./3., 0.528969}, // 8
    {28.57, 30.60, 2.03, 29.58, 1.0016, 2.2864 * 4./3.,  0.430266}, // 9
    {31.40, 33.26, 1.86, 32.33, 0.9963, 3.12153 * 4./3., 0.515049}, //10 - I don't trust this too much
  ...
  /*labels = {
    {"0 #font[42]{d}_{5/2}, 3^{+}, 0.937", "1 #font[42]{s}_{1/2}, 3^{+}, 0.937", "0 #font[42]{d}_{5/2}, 0^{+}, 1.041", "0 #font[42]{d}_{5/2}, 5^{+}, 1.121"},
    {"1 #font[42]{s}_{1/2}, 2^{+}", "0 #font[42]{d}_{5/2}, 2^{+}"}, // 4.964
    {"1 #font[42]{s}_{1/2}, 2^{+}", "0 #font[42]{d}_{5/2}, 2^{+}"}, // 3.061
    {"0 #font[42]{d}_{5/2}, 4^{+}, 4.652", "0 #font[42]{d}_{5/2}, 0^{+}, 4.753"},
    {"0 #font[42]{d}_{5/2}, 1^{+}"}, // 4.360
    {"1 #font[42]{s}_{1/2}, 3^{+}", "0 #font[42]{d}_{5/2}, 2^{+}"}, // 4.115
    {"1 #font[42]{s}_{1/2}, 2^{+}, 3.839", "0 #font[42]{d}_{5/2}, 2^{+}, 3.839", "0 #font[42]{d}_{5/2}, 1^{+}, 3.724"},
    {"0 #font[42]{d}_{5/2}, 1^{+}"}, // 0.000
    };*/
  ...
  TString outputDir = Form("plots_17F/minuit_extra5/ang_dist_newunc/%s", pot.Data());
  gSystem->mkdir(outputDir, kTRUE);
  
  if (checking_gs) {
    //TFile *file = TFile::Open("DWBA_17O_pot_5255.root");
    file = TFile::Open("DWBA_17F_pot_gs.root");
  }
  else
  ...
  for (size_t mappingIndex = 0; mappingIndex < fitMappings.size(); ++mappingIndex) {
    ...
    TLegend* legend = new TLegend(0.6, 0.7, 0.9, 0.89);
